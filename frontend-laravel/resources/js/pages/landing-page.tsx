...
export default function LandingPage() {
    ...
    return (
        <AppLayout>
            <section id="generate-exam" className="flex flex-1 h-[600px] mt-20 flex-col items-center justify-center gap-4 rounded-xl p-4">
            ...
            <section id="features" data-name="features" className="flex flex-1 h-screen w-screen flex-col items-center justify-center gap-4 rounded-xl px-20 ">
