        ...
        <div className="flex flex-col h-screen w-screen py-6">
            <div className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-md h-fit bg-background">
                <form>
                    ...
                    <div className="text-center w-full justify-center gap-4 leading-none mb-10">
                        ...
                        <h1 className="text-xl font-semibold mb-2">Log in to your account</h1>
                        <p className="text-sm font-regular">Enter your email and password below to log in</p>
                    </div>
                    <div className="grid gap-4 bg-background">
                        ...
                        <div className="flex items-center space-x-3">
                            <Checkbox
                                ...
                                name="remember"
                                tabIndex={3}
                                className="border-2 border-card-foreground"
                            />
                        ...
                        <div className="flex flex-row items-center justify-center space-x-1">
                            ...
                            <a href="http://127.0.0.1:8000/exam-generator/signup" className="font-semibold">Sign up</a>
                        </div>
                    </div>
                </form>
            </div>
